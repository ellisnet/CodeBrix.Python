...
static class ABI
{
    ...
    internal static void Initialize(Version version)
    {
        ...
        const string nativeTypeOffsetClassName = "CodeBrix.Python.NativeTypeOffset";
        string className = Invariant($"CodeBrix.Python.TypeOffset{version.Major}{version.Minor}");
