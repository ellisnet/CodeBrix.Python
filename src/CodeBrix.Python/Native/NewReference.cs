...
/// (note <code>this scoped in NewReference</code> vs the usual <code>this NewReference</code>)
/// </summary>
static class NewReferenceExtensions
{
    ...
    [Pure]
    [DebuggerHidden]
    public static IntPtr DangerousGetAddress(this scoped in NewReference reference)
        => NewReference.DangerousGetAddress(reference);
    [Pure]
    [DebuggerHidden]
    public static bool IsNull(this scoped in NewReference reference)
