...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Python.MitLicenseForever - embed CPython in a .NET application,
      call Python from C#, and call .NET from Python through the `clr` module.
