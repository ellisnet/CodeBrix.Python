...
def test_doc_with_ctor():
    from CodeBrix.Python.TestSupport import DocWithCtorTest
...
def test_doc_with_ctor_no_doc():
    from CodeBrix.Python.TestSupport import DocWithCtorNoDocTest
...
def test_doc_without_ctor():
    from CodeBrix.Python.TestSupport import DocWithoutCtorTest
