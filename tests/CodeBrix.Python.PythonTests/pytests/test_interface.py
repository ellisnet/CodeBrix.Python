...
def test_interface_standard_attrs():
    ...
    from CodeBrix.Python.TestSupport import IPublicInterface

    assert IPublicInterface.__name__ == 'IPublicInterface'
    assert IPublicInterface.__module__ == 'CodeBrix.Python.TestSupport'
...
def test_global_interface_visibility():
    ...
    with pytest.raises(ImportError):
        from CodeBrix.Python.TestSupport import IInternalInterface
...
def test_nested_interface_visibility():
    ...
    from CodeBrix.Python.TestSupport import InterfaceTest
...
def test_interface_out_param_python_impl():
    from CodeBrix.Python.TestSupport import IOutArg, OutArgCaller
