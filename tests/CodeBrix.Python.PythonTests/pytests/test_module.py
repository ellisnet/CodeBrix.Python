...
def test_lookup_no_namespace_type():
    ...
    import CodeBrix.Python.TestSupport
    import clr
...
def test_clr_add_reference():
    ...
    for name in ("System", "CodeBrix.Python"):
...
def test_clr_get_clr_type():
    ...
    assert GetClrType(int).FullName == "CodeBrix.Python.PyInt"
...
def test_assembly_load_thread_safety():
    from CodeBrix.Python.TestSupport import ModuleTest
