...
def test_inherited_indexer():
    ...
    from CodeBrix.Python.TestSupport import PublicInheritedIndexerTest
    from CodeBrix.Python.TestSupport import ProtectedInheritedIndexerTest
    from CodeBrix.Python.TestSupport import PrivateInheritedIndexerTest
    from CodeBrix.Python.TestSupport import InternalInheritedIndexerTest
...
def test_inherited_indexer_interface():
    ...
    from CodeBrix.Python.TestSupport import InterfaceInheritedIndexerTest, IInheritedIndexer
