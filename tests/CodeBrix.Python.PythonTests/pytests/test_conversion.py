...
import System
from CodeBrix.Python.TestSupport import ConversionTest, MethodResolutionInt, UnicodeString, CodecResetter
...
def test_interface_conversion():
    ...
    from CodeBrix.Python.TestSupport import Spam, ISpam
...
def test_codecs():
    ...
    class ListAsRawEncoder(RawProxyEncoder):
        __namespace__ = "CodeBrix.Python.TestSupport"
