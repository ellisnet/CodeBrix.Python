...
def test_class_standard_attrs():
    ...
    from CodeBrix.Python.TestSupport import ClassTest

    assert ClassTest.__name__ == 'ClassTest'
    assert ClassTest.__module__ == 'CodeBrix.Python.TestSupport'
...
def test_non_public_class():
    ...
    with pytest.raises(ImportError):
        from CodeBrix.Python.TestSupport import InternalClass
...
def test_non_exported():
    """Test [PyExport(false)]"""
    with pytest.raises(ImportError):
        from CodeBrix.Python.TestSupport import NonExportable
...
def test_subclass_with_no_arg_constructor():
    ...
    from CodeBrix.Python.TestSupport import ClassCtorTest1
...
def test_subclass_with_various_constructors():
    ...
    from CodeBrix.Python.TestSupport import ClassCtorTest2
...
def test_struct_construction():
    ...
    from CodeBrix.Python.TestSupport import Point
