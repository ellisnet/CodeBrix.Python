...
def assert_generic_wrapper_by_type(ptype, value):
    """Test Helper"""
    from CodeBrix.Python.TestSupport import GenericWrapper
    import System
...
def assert_generic_method_by_type(ptype, value, test_type=0):
    """Test Helper"""
    from CodeBrix.Python.TestSupport import GenericMethodTest, GenericStaticMethodTest
    import System
...
def test_generic_reference_type():
    ...
    from CodeBrix.Python.TestSupport import GenericTypeDefinition
...
def test_generic_value_type():
    ...
    from CodeBrix.Python.TestSupport import GenericStructConstructorTest
...
def test_open_generic_type():
    ...
    from CodeBrix.Python.TestSupport import DerivedFromOpenGeneric
...
def test_generic_type_name_resolution():
    ...
    from CodeBrix.Python.TestSupport import GenericNameTest1, GenericNameTest2
...
def test_generic_type_binding():
    ...
    from CodeBrix.Python.TestSupport import InterfaceTest, ISayHello1, ShortEnum
    import System
...
def test_method_overload_selection_with_generic_types():
    ...
    from CodeBrix.Python.TestSupport import ISayHello1, InterfaceTest, ShortEnum
    from CodeBrix.Python.TestSupport import MethodTest, GenericWrapper
...
def test_overload_generic_parameter():
    from CodeBrix.Python.TestSupport import MethodTest, MethodTestSub
...
def test_invalid_generic_type_parameter():
    from CodeBrix.Python.TestSupport import GenericTypeWithConstraint
    with pytest.raises(TypeError):
        GenericTypeWithConstraint[System.Object]

def test_invalid_generic_method_type_parameter():
    from CodeBrix.Python.TestSupport import ConversionTest
    with pytest.raises(TypeError):
...
def test_generic_list_array_conversion():
    ...
    from CodeBrix.Python.TestSupport import GenericArrayConversionTest
    from CodeBrix.Python.TestSupport import Spam
