...
import System
import pytest
from CodeBrix.Python.TestSupport import DelegateTest, StringDelegate
...
def test_delegate_standard_attrs():
    ...
    from CodeBrix.Python.TestSupport import PublicDelegate

    assert PublicDelegate.__name__ == 'PublicDelegate'
    assert PublicDelegate.__module__ == 'CodeBrix.Python.TestSupport'
...
def test_global_delegate_visibility():
    ...
    with pytest.raises(ImportError):
        from CodeBrix.Python.TestSupport import InternalDelegate
        _ = InternalDelegate
...
def test_bool_delegate():
    ...
    from CodeBrix.Python.TestSupport import BoolDelegate
...
def test_object_delegate():
    ...
    from CodeBrix.Python.TestSupport import ObjectDelegate
...
def test_out_int_delegate():
    ...
    from CodeBrix.Python.TestSupport import OutIntDelegate
    value = 7
...
def test_out_string_delegate():
    ...
    from CodeBrix.Python.TestSupport import OutStringDelegate
    value = 'goodbye'
...
def test_ref_int_delegate():
    ...
    from CodeBrix.Python.TestSupport import RefIntDelegate
    value = 7
...
def test_ref_string_delegate():
    """Test delegate with a ref string parameter."""
    from CodeBrix.Python.TestSupport import RefStringDelegate
    value = 'goodbye'
...
def test_ref_int_ref_string_delegate():
    ...
    from CodeBrix.Python.TestSupport import RefIntRefStringDelegate
    intData = 7
    stringData = 'goodbye'
...
def test_int_ref_int_ref_string_delegate():
    """Test delegate with a ref int and ref string parameter."""
    from CodeBrix.Python.TestSupport import IntRefIntRefStringDelegate
    intData = 7
    stringData = 'goodbye'
