...
import System
import pytest
from CodeBrix.Python.TestSupport import (IInterfaceTest, SubClassTest, EventArgsTest,
...
def interface_test_class_fixture(subnamespace):
    ...
    class InterfaceTestClass(IInterfaceTest):
        ...
        __namespace__ = "CodeBrix.Python.TestSupport." + subnamespace
...
def test_derived_traceback():
    ...
    class DerivedClass(SubClassTest):
        __namespace__ = "CodeBrix.Python.TestSupport.traceback"
...
def test_can_be_collected_by_gc():
    from CodeBrix.Python.TestSupport import BaseClass
...
def test_generic_interface():
    ...
    from CodeBrix.Python.TestSupport import GenericInterfaceUser, SpecificInterfaceUser
...
def test_nested_namespaced_subclass_finalize_no_double_queue():
    ...
    memory.  Reliably reproduced under Mono in CI during the upstream
    free-threading work; CoreCLR happened to mask it via GC timing.
    """
