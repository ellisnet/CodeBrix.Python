...
def test_enum_constructor():
    ...
    from CodeBrix.Python.TestSupport import EnumConstructorTest
...
def test_flags_constructor():
    ...
    from CodeBrix.Python.TestSupport import FlagsConstructorTest
...
def test_struct_constructor():
    ...
    from CodeBrix.Python.TestSupport import StructConstructorTest
...
def test_subclass_constructor():
    ...
    from CodeBrix.Python.TestSupport import SubclassConstructorTest
...
def test_multiple_constructor():
    from CodeBrix.Python.TestSupport import MultipleConstructorsTest
...
def test_default_constructor_fallback():
    from CodeBrix.Python.TestSupport import DefaultConstructorMatching
...
def test_constructor_leak():
    ...
    from CodeBrix.Python import Runtime
