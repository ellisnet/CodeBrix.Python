...
import gc
import tracemalloc
from CodeBrix.Python.TestSupport import MethodTest
...
def test_unbound_managed_method_call():
    ...
    from CodeBrix.Python.TestSupport import MethodTestSub
...
def test_keyword_arg_method_resolution():
    from CodeBrix.Python.TestSupport import MethodArityTest
