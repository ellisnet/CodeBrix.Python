...
// The upstream file also declares the separate PlainOldNamespace namespace, which the Python
// test suite imports by name. A file-scoped namespace can only declare one, so that part lives
// in plainoldclass.cs alongside this file.
